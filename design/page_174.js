...
async function create_module_from_json(p_pog_json_arr, p_new_pog_ind, p_pog_type, p_product_open, p_pog_opened, p_stop_loading, p_create_pdf_ind, p_recreate, p_create_json, p_showSingleModule, p_org_mod_index, p_pog_index) {
    try {
        ...
        if ($v('P174_POGCR_DFT_NOTCH_LABEL') == "Y") {
            g_show_notch_label = 'Y';
            //show_notch_labels("Y", $v("P174_NOTCH_HEAD"), "Y", p_pog_index);
        }
        if ($v('P174_POGCR_DFT_FIXEL_LABEL') == "Y") {
            g_show_fixel_label = 'Y';
            //show_fixel_labels("Y", p_pog_index);
        }
        if ($v('P174_POGCR_SHOW_DFLT_ITEM_LOC') == "Y") {
            g_show_item_label = 'Y';
            //show_item_labels("Y", $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), p_pog_index);
        }
        //End ASA-1371_26842

        await create_module_from_json_lib(p_pog_json_arr, p_new_pog_ind, p_pog_type, p_product_open, p_pog_opened, p_recreate, p_create_json, $v("P174_VDATE"), $v("P174_POG_DEFAULT_COLOR"), $v("P174_MODULE_DEFAULT_COLOR"), null, false, p_showSingleModule, p_org_mod_index, $v("P174_POGCR_DFT_SPREAD_PRODUCT"), parseFloat($v("P174_PEGBOARD_DFT_HORZ_SPC")), parseFloat($v("P174_PEGBOARD_DFT_VERT_SPC")), parseFloat($v("P174_BASKET_WALL_THICK")), parseFloat($v("P174_CHEST_WALL_THICK")), $v("P174_POGCR_PEG_ITEM_AUTO_PLACE"), $v("P174_POGCR_DEFAULT_WRAP_TEXT"), parseInt($v("P174_POGCR_TEXT_DEFAULT_SIZE")), $v("P174_POG_TEXTBOX_DEFAULT_COLOR"), $v("P174_SHELF_DEFAULT_COLOR"), $v("P174_DIV_COLOR"), $v("P174_SLOT_DIVIDER"), $v("P174_SLOT_ORIENTATION"), $v("P174_DIVIDER_FIXED"), $v("P174_ITEM_DFT_COLOR"), $v("P174_POGCR_DELIST_ITEM_DFT_COLOR"), "Y", null, 1, $v("P174_MERCH_STYLE"), $v("P174_POGCR_LOAD_IMG_FROM"), $v("P174_BU_ID"), $v("P174_POGCR_DELIST_ITEM_DFT_COLOR"), $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), $v("P174_NOTCH_HEAD"), "N", $v("P174_POGCR_DFT_BASKET_FILL"), $v("P174_POGCR_DFT_BASKET_SPREAD"), g_scene_objects[0].scene.children[0], p_pog_index, p_org_mod_index, $v("P174_POGCR_NOTCH_START_VALUE"), "N", "Y", "N"); //--ASA-1310 prasanna ASA-1310_20240307 //Regression 29(Portal Issue) added p_calc_dayofsupply
        //Review: P174_POGCR_DEFAULT_WRAP_TEXT add item on page with value Y or parameter

        if ($v("P174_POGCR_DFT_ITEM_DESC") == "Y" || (g_ItemImages.length == 0 && $v("P174_POGCR_DFLT_LIVE_IMAGES") == "Y")) {
            await showHideItemDescription("Y", $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), p_pog_index);
            $v("P174_POGCR_DFT_ITEM_DESC") == "Y" ? g_show_live_image = "N" : "";
            g_show_item_desc = 'Y';
        }

        await get_all_images(p_pog_index, "N", "N", $v("P174_POGCR_IMG_MAX_WIDTH"), $v("P174_POGCR_IMG_MAX_HEIGHT"), $v("P174_IMAGE_COMPRESS_RATIO"));
        $("#LIVE_IMAGE").removeClass("apex_disabled");
        if (g_ItemImages.length > 0 && p_create_pdf_ind == "N" && $v("P174_POGCR_DFLT_LIVE_IMAGES") == "Y" && $v("P174_POGCR_DFT_ITEM_DESC") == "N") {
            try {
                g_show_live_image = "Y";
                var return_val = await recreate_image_items('Y', $v("P174_MERCH_STYLE"), $v("P174_POGCR_LOAD_IMG_FROM"), $v("P174_BU_ID"), $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), $v("P174_POGCR_DELIST_ITEM_DFT_COL"), $v("P174_NOTCH_HEAD"), p_pog_index, 'N');
                animate_pog(p_pog_index);
            } catch (err) {
                error_handling();
            }
        }
        console.log('P174_POGCR_DFT_NOTCH_LABEL', $v('P174_POGCR_DFT_NOTCH_LABEL'), $v('P174_POGCR_DFT_FIXEL_LABEL'), $v('P174_POGCR_SHOW_DFLT_ITEM_LOC'));
        ...
        await generateCombinedShelfs(p_pog_index, m, s, $v("P174_POGCR_DELIST_ITEM_DFT_COL"), $v("P174_MERCH_STYLE"), $v("P174_POGCR_LOAD_IMG_FROM"), $v("P174_BU_ID"), $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), 'N', 'N'); //g_merge_items, p_calc_days_of_supply-- mergeAdjacentItems and calculateFixelAndSupplyDays not needed to call from this page.
        }
        s++;
        }
        m++;
...
function doMouseMove(p_x, p_y, p_event, p_prevX, p_prevY, p_canvas, p_pogjson_opp, p_jselector, p_pog_index) {
    ...
    try {
        ...
        if (g_intersects.length > 0 && typeof g_intersects[0].object.ItemID !== "undefined" && g_intersects[0].object.ItemID !== "" && g_intersects[0].object.ItemID !== "DIVIDER") {
            var desc_list_arr = $v("P174_POGCR_ITEM_DESC_LIST").split(":"); //ASA-1407 Task 1
            ...
            if (sessionStorage.getItem("new_pog_ind") == "Y") {
                var draft_version = divider + get_message("POGCR_DRAFT_VERSION") + ': <span style="color:yellow">' + sessionStorage.getItem("P174_EXISTING_DRAFT_VER") + " </span> ";
                var pogversion = "";
            } else {
                var draft_version = "";
...
async function set_scene(p_pog_details, p_save_pdf, p_notch_label, p_fixel_label, p_item_label, p_pdf_lang, p_save_pog, p_mime_type, p_new_item_label, p_show_item_desc, p_draftPogInd, p_item_desc, p_old_live_iamge, p_loaded_live_img, p_pog_index, p_generateLiveImg, p_workflowSave = "N", p_draftSeqID = "", p_combineImgInd, p_pdfnotchlabel, p_pdfFixelLabel, p_pdfItemLabel) {
    ...
    if ($v('P174_POGCR_ENHANCE_PDF_IMG') == 'Y') { //ASA-1344
        enhance = parseFloat($v('P174_POGCR_PDF_IMG_ENHANCE_RATIO'));
    }
    var can_dim_arr = ($v('P174_POGCR_PDF_CANVAS_SIZE')).split(':'); //ASA-1344
    ...
    if (details[0] == 'Y') {
        if (details[1] == 'Y') {
            if (p_loaded_live_img == 'N') {
                var return_val = await recreate_image_items('N', $v("P174_MERCH_STYLE"), $v("P174_POGCR_LOAD_IMG_FROM"), $v("P174_BU_ID"), $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), $v("P174_POGCR_DELIST_ITEM_DFT_COL"), $v("P174_NOTCH_HEAD"), p_pog_index, 'N');
    ...
    /*var pogChests = [];Start TAsk_26829
    var mIndex = 0;
    ...
    var module_no = chest.MIndex + 1; //ASA-1314 it was using mi before
    ...
    console.log("cameraz, new_y", cameraz, new_y);
    ...
    p.done(function (data) {
        ...
        async function dosomething() {
            ...
            show_notch_labels(g_show_notch_label, $v("P174_NOTCH_HEAD"), "Y", p_pog_index);
            show_fixel_labels(g_show_fixel_label, p_pog_index);
            show_item_labels(g_show_item_label, $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), p_pog_index);
...
function doMouseDown(p_x, p_y, p_startX, p_startY, p_event, p_canvas, p_context_call, p_pog_index) {
    ...
    try {
        ...
        $s("P174_SELECTED_CANVAS", `${g_curr_canvas}`);
...
$(document).keydown(function (e) {
    ...
    if (e.keyCode == 38 && e.ctrlKey == true && typeof new_POGJSON !== "undefined" && new_POGJSON.length > 0) {
        ...
        new_camera.position.set(new_camera.position.x, new_camera.position.y, new_camera.position.z - parseFloat($v("P174_POGCR_CAMERA_ZOOM_FACTOR")));
        g_manual_zoom_ind = "Y";
        render();
...
function onDocumentMouseWheel(p_event) {
    ...
    if (p_event.ctrlKey) {
        ...
        var factor = parseFloat($v("P174_POGCR_CAMERA_ZOOM_FACTOR"));
        ...
        if (g_manual_zoom_ind == "Y") {
            var scroll_interval = parseFloat($v("P174_POGCR_WHEEL_UP_DOWN_INTER"));
...
function get_pog_layout() {
    ...
    p.done(function (data) {
        ...
        var model = apex.region("ig_mod_details").widget().interactiveGrid("getViews", "grid").model;
        var returnval = true;
        if ($v('P174_POG_MODULE') !== '') {
            l_selected_mod = $v('P174_POG_MODULE');
        }
        if (moduleName !== '') {
            apex.region("ig_mod_details").widget().interactiveGrid("getCurrentView").view$.grid("setSelectedRecords", [mod_rec], true);
            if (g_pog_json_data.length > 0) {
...
async function create_pdf_func() {
    if ($v('P174_DEFAULT_TEMPLATE') == '') {
        ...
        var p_pog_details = {
            'SeqNo': '',
            'POGCode': $v('P174_POG_CODE'),
            'POGVersion': $v('P174_POG_VERSION'),
            'POGModule': l_selected_mod,
            'Selection_Type': 'E',
            'Print_Type': 'P',
            'SequenceId': '',
            'TemplateId': $v("P174_DEFAULT_TEMPLATE").split('-')[0],
            'TemplateDetails': $v("P174_DEFAULT_TEMPLATE")
        };
        //ASA-1371_26842
        await create_pdf(p_pog_details, 'N', 'N', g_pog_json, "E", $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), $v("P174_NOTCH_HEAD"), "N", g_pog_index, 'N', 'N', $v("P174_MERCH_STYLE"), $v("P174_POGCR_LOAD_IMG_FROM"), $v("P174_BU_ID"), $v("P174_POGCR_ITEM_NUM_LBL_COLOR"), $v("P174_POGCR_ITEM_NUM_LABEL_POS"), $v("P174_POGCR_DISPLAY_ITEM_INFO"), $v("P174_POGCR_DELIST_ITEM_DFT_COL"), $v("P174_NOTCH_HEAD"));
...
async function comparePOG(p_compare_ind, p_pog_code, p_pog_version, p_draft_id, p_prev_version) {
    ...
    try {
        ...
        p.done(function (data) {
            ...
            if (return_data.match(/ERROR.*/)) {
                ...
                apex.server.process("ADD_POG_VERSION_TO_ARRAY", {
                        x01: $v("1"),
                        x02: $v("2"),
                        x03: $v("3"),
                        x04: $v("4")
                        ...
                        dataType: "text",
                        success: function (l_pog_dtl_clob) {
                        }
                    });
console.log("view_ind", l_pog_dtl_clob);
                async function doSomething() {
