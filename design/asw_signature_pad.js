...
!(function (t, e) {
    ...
    class n extends i {
        ...
        _strokeBegin(t) {
            ...
            const { addEventListener: e } = this._getListenerFunctions();
            switch (t.event.type) {
                case "mousedown":
            ...
            const i = this._getPointGroupOptions(),
                n = Object.assign(Object.assign({}, i), { points: [] });
        ...
        _strokeUpdate(t) {
            ...
            if (!s || !s || !o) {
                ...
                s ? t && this._drawCurve(t, r) : this._drawDot(e, r), n.push({ time: e.time, x: e.x, y: e.y, pressure: e.pressure });
            }
