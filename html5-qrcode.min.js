function getLazarSoftScanner() {
    ...
    function r(e, t, n, r, i, a) {
        ...
        this.buildFunctionPattern = function () {
            ...
            this.versionNumber > 6 && (t.setRegion(e - 11, 0, 3, 6), t.setRegion(0, e - 11, 6, 3)),
            t
        },
    ...
    function o(t) {
        ...
        this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, n, r) {
            ...
            return a = 1,
            s < 0 ? (a = t / (t - s), s = 0) : s >= A.height && (a = (A.height - 1 - t) / (s - t), s = A.height - 1),
        ...
        this.createTransform = function (e, t, n, r, a) {
            ...
            w,
            f = a - 3.5;
            return null != r ? (o = r.X, s = r.Y, h = w = f - 3) : (o = t.X - e.X + n.X, s = t.Y - e.Y + n.Y, h = w = f),
    ...
    e.checkAndNudgePoints = function (e, t) {
        for (var n = A.width, r = A.height, i = !0, a = 0; a < t.length && i; a += 2) {
            ...
            -1 == s ? (t[a + 1] = 0, i = !0) : s == r && (t[a + 1] = r - 1, i = !0)
        }
        i = !0;
    ...
    function I(e, t, n) {
        ...
        this.getFigureString = function (e) {
            ...
            r = "";
            do {
                t >= 3 ? ((n = this.getNextBits(10)) < 100 && (r += "0"), n < 10 && (r += "0"), t -= 3) : 2 == t ? ((n = this.getNextBits(7)) < 10 && (r += "0"), t -= 2) : 1 == t && (n = this.getNextBits(4), t -= 1),
                r += n
            } while (t > 0);
            return r
        },
...
var Html5Qrcode = function () {
    ...
    return _createClass(a, [{
                ...
                value: function (b, c, d, e) {
                    ...
                    r = function (a) {
                        return new Promise(function (b, c) {
                            ...
                            if (g._localMediaStream = a, j || !h.aspectRatio)
                                d();
                            else {
                                var e = {
                ...
                value: function (b) {
                    if (!b)
                        return a._logError("Empty videoConstraints", !0), !1;
                    if ("object" !== _typeof(b)) {
                        var c = _typeof(b);
                    ...
                    for (var d, e = ["autoGainControl", "channelCount", "echoCancellation", "latency", "noiseSuppression", "sampleRate", "sampleSize", "volume"], f = new Set(e), g = Object.keys(b), h = 0; h < g.length; h++)
                        if (d = g[h], f.has(d))
                            return a._logError("".concat(d, " is not supported videoConstaints."), !0), !1;
                    return !0
                }
            }
        ], [{
                ...
                value: function () {
                    ...
                    return new Promise(function (b, c) {
                        if (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && navigator.mediaDevices.getUserMedia)
                            a._log("navigator.mediaDevices used"), navigator.mediaDevices.getUserMedia({
                                audio: !1,
                                video: !0
                            }).then(function (d) {
                                ...
                                navigator.mediaDevices.enumerateDevices().then(function (c) {
                                    for (var f, g = [], h = 0; h < c.length; h++)
                                        f = c[h], "videoinput" == f.kind && g.push({
                                            id: f.deviceId,
                                            label: f.label
                                        });
                ...
                value: function () {
                    ...
                    g.addEventListener("click", function () {
                        ...
                        Html5Qrcode.getCameras().then(function (c) {
                            ...
                            c && 0 != c.length ? (e.removeChild(f), b.__renderCameraSelection(c)) : b.__setStatus("No Cameras", a.STATUS_WARNING)
                        })["catch"](function (c) {
                            g.disabled = !1,
                            b.__setStatus("IDLE"),
